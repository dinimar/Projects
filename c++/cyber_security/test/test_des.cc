...
BOOST_AUTO_TEST_CASE(des_encrypt)
{
  ...
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0800000000000000, des_vector_key.encrypt(0x20B9E767B2FB1456));
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0400000000000000, des_vector_key.encrypt(0x55579380D77138EF));
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0200000000000000, des_vector_key.encrypt(0x6CC5DEFAAF04512F));
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0100000000000000, des_vector_key.encrypt(0x0D9F279BA5D87260));
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0080000000000000, des_vector_key.encrypt(0xD9031B0271BD5A0A));
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0040000000000000, des_vector_key.encrypt(0x424250B37C3DD951));
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0020000000000000, des_vector_key.encrypt(0xB8061B7ECD9A21E5));
  BOOST_CHECK_BITWISE_EQUAL((int64_t)0x0010000000000000, des_vector_key.encrypt(0xF15D0F286B65BD28));
...
BOOST_AUTO_TEST_CASE(des_decrypt)
{
  ...
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0x20B9E767B2FB1456, des_vector_key.decrypt(0x0800000000000000));
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0x55579380D77138EF, des_vector_key.decrypt(0x0400000000000000));
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0x6CC5DEFAAF04512F, des_vector_key.decrypt(0x0200000000000000));
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0x0D9F279BA5D87260, des_vector_key.decrypt(0x0100000000000000));
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0xD9031B0271BD5A0A, des_vector_key.decrypt(0x0080000000000000));
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0x424250B37C3DD951, des_vector_key.decrypt(0x0040000000000000));
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0xB8061B7ECD9A21E5, des_vector_key.decrypt(0x0020000000000000));
  BOOST_CHECK_BITWISE_EQUAL((uint64_t)0xF15D0F286B65BD28, des_vector_key.decrypt(0x0010000000000000));
}
